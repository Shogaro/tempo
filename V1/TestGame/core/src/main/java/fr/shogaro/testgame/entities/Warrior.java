...
public class Warrior extends Character{
    ...
    private static int HEALTH_MAX = 125;
    private static int HEALTH_CURRENT;
    private static int DAMAGE = 75;
    private static float ATTACK_SPEED = 0.8f;
    private static float ATTACK_RANGE = 1.5f;
    private static float SPEED = 125;
    ...
    private void loadAnimations() {
        String basePath = "characters/iop";
        ...
        addAnimation(State.MOVE, Direction.RIGHT, buildAnimationSeries(basePath + "/movement/animatedRight", "viewLeft", 4, moveFrame, Animation.PlayMode.LOOP));
        ...
        addAnimation(State.IDLE, Direction.RIGHT, buildSingleFrame(basePath + "/movement/animatedRight/viewLeft1.png"));
        ...
        addAnimation(State.ATTACK, Direction.BOTTOM_RIGHT, buildAnimationSeries(basePath + "/attack/animatedBottomRight", "viewBottomLeft", 3, attackFrame, Animation.PlayMode.NORMAL));
